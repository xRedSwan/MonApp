...
import com.example.marti.monapp.activities.jeux.MoulinActivity;
...
public class ConstantesJava {
    ...
    public static Jeux[] InitArrayJeux(Context context){
        ...
        Jeux Moulin = new Jeux("Moulin",R.drawable.moulin, new Intent(context, MoulinActivity.class));

        return new Jeux[]{Dames, Sudoku, Puissance4, Chevaux, BatailleNavale, Echecs, Moulin};
    }
    ...
    public final static int CODEM=6;
    public final static String KM="moulin";
